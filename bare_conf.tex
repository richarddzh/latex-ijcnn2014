...
\begin{figure}[htp]
\centering
\subfloat[Odd symmetry]{\includegraphics[width=0.3\linewidth]{images/fig4a.eps}\label{fig:4a}}\hfil
\subfloat[Even symmetry]{\includegraphics[width=0.3\linewidth]{images/fig4b.eps}\label{fig:4b}}
