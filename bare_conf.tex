...
\IEEEauthorblockA{School of Computer Science, Fudan University\\
Shanghai, China\\
weihui@fudan.edu.cn}}
...
\begin{figure}[htp]
\centering
\subfloat[]{\includegraphics[width=0.18\linewidth]{images/fig2a.png}\label{fig:2a}}\hfil
\subfloat[]{\includegraphics[width=0.36\linewidth]{images/fig2b.png}\label{fig:2b}}\hfil
\subfloat[]{\includegraphics[width=0.36\linewidth]{images/fig2c.png}\label{fig:2c}}
...
\begin{figure}[htp]
\centering
\subfloat[Response map]{\includegraphics[width=0.48\linewidth]{images/fig6a.png}\label{fig:6a}}\hfil
\subfloat[Weight matrices]{\includegraphics[width=0.48\linewidth]{images/fig6b.png}\label{fig:6b}}
...
\begin{figure}[htp]
\centering
\subfloat[Patterns]{\includegraphics[width=0.24\linewidth]{images/fig7a.png}\label{fig:7a}}\hfil
\subfloat[Response map]{\includegraphics[width=0.24\linewidth]{images/fig7b.png}\label{fig:7b}}\hfil
\subfloat[Response map]{\includegraphics[width=0.24\linewidth]{images/fig7c.png}\label{fig:7c}}\hfil
\subfloat[Response map]{\includegraphics[width=0.24\linewidth]{images/fig7d.png}\label{fig:7d}}
...
{\includegraphics[width=0.9\linewidth]{images/fig8a.png}\label{fig:8a}}\\
\subfloat[Response map of a neuron selective for helix shapes (Selectivity index = 6.37).]%
{\includegraphics[width=0.9\linewidth]{images/fig8b.png}\label{fig:8b}}
...
\begin{figure}[htp]
\centering
\subfloat[Patterns]{\includegraphics[width=0.31\linewidth]{images/fig9a.png}\label{fig:9a}}\hfil
\subfloat[Response map]{\includegraphics[width=0.31\linewidth]{images/fig9b.png}\label{fig:9b}}\hfil
\subfloat[Response map]{\includegraphics[width=0.31\linewidth]{images/fig9c.png}\label{fig:9c}}
...
\begin{figure}[htp]
\centering
\subfloat[Car image]{\includegraphics[width=0.32\linewidth]{images/fig11a.png}\label{fig:11a}}\hfil
\subfloat[Activity map]{\includegraphics[width=0.32\linewidth]{images/fig11c.png}\label{fig:11b}}\hfil
\subfloat[Entropy map]{\includegraphics[width=0.32\linewidth]{images/fig11e.png}\label{fig:11c}}\\
\subfloat[Face image]{\includegraphics[width=0.32\linewidth]{images/fig11b.png}\label{fig:11d}}\hfil
\subfloat[Activity map]{\includegraphics[width=0.32\linewidth]{images/fig11d.png}\label{fig:11e}}\hfil
\subfloat[Entropy map]{\includegraphics[width=0.32\linewidth]{images/fig11f.png}\label{fig:11f}}\\
\subfloat[Salient points]{\includegraphics[width=0.49\linewidth]{images/fig11g.eps}\label{fig:11g}}\hfil
\subfloat[Salient points]{\includegraphics[width=0.49\linewidth]{images/fig11h.eps}\label{fig:11h}}
...
\begin{figure}[htp]
\centering
\subfloat[The same face]{\includegraphics[width=0.85\linewidth]{images/fig12a.eps}\label{fig:12a}}\\
\subfloat[Different faces]{\includegraphics[width=0.85\linewidth]{images/fig12b.eps}\label{fig:12b}}
...
\begin{figure}[htp]
\centering
\subfloat[Our matches]{\includegraphics[width=0.99\linewidth]{images/fig13a.png}\label{fig:13a}}\\
\subfloat[SIFT matches]{\includegraphics[width=0.99\linewidth]{images/fig13b.png}\label{fig:13b}}
